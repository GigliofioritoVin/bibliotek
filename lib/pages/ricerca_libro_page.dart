...
class RicercaLibroPage extends StatefulWidget {
  const RicercaLibroPage({super.key});

  @override
  _RicercaLibroPageState createState() => _RicercaLibroPageState();
}

class _RicercaLibroPageState extends State<RicercaLibroPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Ricerca Libro')),
      body: Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (_selectedBook != null) {
                              ...
                              await _flutterTts
                                  .speak("Dirigiti verso gli scaffali");
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => NavigazioneQRPage(
                                        collocazioneLibro: collocazioneLibro,
