...
class NavigazioneQRPage extends StatefulWidget {
  final String collocazioneLibro; // Riceve la collocazione del libro
  final String titleLibro;

  const NavigazioneQRPage(
      {Key? key, required this.collocazioneLibro, required this.titleLibro})
      : super(key: key);

  @override
  _NavigazioneQRPageState createState() => _NavigazioneQRPageState();
}

class _NavigazioneQRPageState extends State<NavigazioneQRPage> {
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        RiconoscimentoLibroPage(titleLibro: widget.titleLibro),
                  ),
                );
              },
              child: Text("OK"),
